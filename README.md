...
Repository: [Copperhead](https://github.com/uberslaw/Copperhead)

## What it does

**Debugging** runs as a real Windows service under **Local System** (full local admin rights for stopping services). A small **system tray app** starts at login so you can toggle monitoring on/off and view the event log.
